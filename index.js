...
*/
console.log(createMenuItem("soda", 2, "Side Item"));
console.log(createMenuItem("lemon cake", 3.50, "dessert"));
console.log(createMenuItem("Chef Salad", 5.50, "Salads"));
...
function getLastReview(array) {
  return "${array[array.length -1].name} gave the restaurant a ${array[array.length -1].rating} star review, and their feedback was: $array{array[array.length -1].feedback}";
} 
